...
public class GroupNoticeActivity extends ECSuperActivity implements
    ...
    protected int getLayoutId() {
        return com.jiujiu.ecdemo.R.layout.group_notice_activity;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getTopBarView().setTopBarToStatus(1, com.jiujiu.ecdemo.R.drawable.topbar_back_bt, getString(com.jiujiu.ecdemo.R.string.app_clear), getString(com.jiujiu.ecdemo.R.string.app_title_notice), this);
    }
    ...
    private void initView() {
        ...
        mListView = (ListView) findViewById(com.jiujiu.ecdemo.R.id.group_notice_lv);
        View mCallEmptyView = findViewById(com.jiujiu.ecdemo.R.id.empty_conversation_tv);
    ...
    public class GroupNoticeAdapter extends CCPListAdapter<DemoGroupNotice> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null || convertView.getTag() == null) {
                view = View.inflate(mContext, com.jiujiu.ecdemo.R.layout.group_notice_list_item, null);

                mViewHolder = new ViewHolder();
                mViewHolder.msgType = (TextView) view.findViewById(com.jiujiu.ecdemo.R.id.msg_type);
                mViewHolder.nickname = (TextView) view.findViewById(com.jiujiu.ecdemo.R.id.user_nickname);
                mViewHolder.ImageViewHeader = (ImageView) view.findViewById(com.jiujiu.ecdemo.R.id.ImageViewHeader);
                mViewHolder.msgTime = (TextView) view.findViewById(com.jiujiu.ecdemo.R.id.msg_time);
                mViewHolder.sysMsgFrom = (TextView) view.findViewById(com.jiujiu.ecdemo.R.id.sysMsg_from);
                mViewHolder.resultShow = (TextView) view.findViewById(com.jiujiu.ecdemo.R.id.result_show);
                mViewHolder.resultSummary = (TextView) view.findViewById(com.jiujiu.ecdemo.R.id.result_summary);
                mViewHolder.acceptBtn = (Button) view.findViewById(com.jiujiu.ecdemo.R.id.accept_btn);
                mViewHolder.refuseBtn = (Button) view.findViewById(com.jiujiu.ecdemo.R.id.Refuse_btn);
            ...
            mViewHolder.sysMsgFrom.setText(getString(com.jiujiu.ecdemo.R.string.str_system_come_from, item.getGroupName()));
            ...
            if(item.getConfirm() == GroupNoticeHelper.SYSTEM_MESSAGE_NEED_REPLAY) {
                ...
                if (item.getConfirm() == GroupNoticeHelper.SYSTEM_MESSAGE_REFUSE) {
                    mViewHolder.resultShow.setText(com.jiujiu.ecdemo.R.string.str_system_message_operation_result_refuse);
                } else if (item.getConfirm() == GroupNoticeHelper.SYSTEM_MESSAGE_THROUGH) {
                    mViewHolder.resultShow.setText(com.jiujiu.ecdemo.R.string.str_system_message_operation_result_through);
    ...
    void showProcessDialog(String tips) {
        mPostingdialog = new ECProgressDialog(GroupNoticeActivity.this, com.jiujiu.ecdemo.R.string.login_posting_submit);
        mPostingdialog.show();
    }
