...
import com.jiujiu.ecdemo.common.ECContentObservers;
import com.jiujiu.ecdemo.common.base.CCPCustomViewPager;
import com.jiujiu.ecdemo.common.base.CCPLauncherUITabView;
...
import com.jiujiu.ecdemo.ui.account.LoginActivity;
...
import com.jiujiu.ecdemo.ui.contact.MobileContactActivity;
import com.jiujiu.ecdemo.ui.contact.MobileContactSelectActivity;
import com.jiujiu.ecdemo.ui.group.BaseSearch;
import com.jiujiu.ecdemo.ui.group.CreateGroupActivity;
import com.jiujiu.ecdemo.ui.group.ECDiscussionActivity;
...
//		MobclickAgent.setDebugMode(true);
	...
	private void initWelcome() {
		...
		if (!mInit) {
			mInit = true;
			setContentView(com.jiujiu.ecdemo.R.layout.splash_activity);
	...
	private void initLauncherUIView() {
		mLauncherView = getLayoutInflater().inflate(com.jiujiu.ecdemo.R.layout.main_tab, null);
		setContentView(mLauncherView);

		mTabViewInit = true;
		mCustomViewPager = (CCPCustomViewPager) findViewById(com.jiujiu.ecdemo.R.id.pager);
		...
		mLauncherUITabView = (CCPLauncherUITabView) findViewById(com.jiujiu.ecdemo.R.id.laucher_tab_top);
		...
		findViewById(com.jiujiu.ecdemo.R.id.btn_plus).setOnClickListener(this);
		findViewById(com.jiujiu.ecdemo.R.id.btn_plus).setOnLongClickListener(this);
		ctrlViewTab(0);
		...
		if (firstUse) {
			if (IMChattingHelper.isSyncOffline()) {
				mPostingdialog = new ECProgressDialog(this,
						com.jiujiu.ecdemo.R.string.tab_loading);
	...
	void initOverflowItems() {
		if (mItems == null) {
			if (SDKCoreHelper.getInstance().isSupportMedia()) {
				...
				mItems[0] = new OverflowAdapter.OverflowItem(getString(com.jiujiu.ecdemo.R.string.main_plus_inter_phone));
				mItems[1] = new OverflowAdapter.OverflowItem( getString(com.jiujiu.ecdemo.R.string.main_plus_meeting_voice));
				mItems[2] = new OverflowAdapter.OverflowItem( getString(com.jiujiu.ecdemo.R.string.main_plus_meeting_video));
				mItems[3] = new OverflowAdapter.OverflowItem( getString(com.jiujiu.ecdemo.R.string.main_plus_groupchat));
				mItems[4] = new OverflowAdapter.OverflowItem( getString(com.jiujiu.ecdemo.R.string.main_plus_querygroup));
...
//				mItems[6] = new OverflowAdapter.OverflowItem( getString(R.string.main_plus_money));
				mItems[5] = new OverflowAdapter.OverflowItem( getString(com.jiujiu.ecdemo.R.string.main_plus_settings));
//				mItems[7] = new OverflowAdapter.OverflowItem(getString(R.string.main_plus_mcmessage));
				...
				mItems[0] = new OverflowAdapter.OverflowItem( getString(com.jiujiu.ecdemo.R.string.main_plus_groupchat));
				mItems[1] = new OverflowAdapter.OverflowItem( getString(com.jiujiu.ecdemo.R.string.main_plus_querygroup));
...
//				mItems[3] = new OverflowAdapter.OverflowItem( getString(R.string.main_plus_money));
				mItems[2] = new OverflowAdapter.OverflowItem( getString(com.jiujiu.ecdemo.R.string.main_plus_settings));
...
//		MobclickAgent.onResume(this);
	...
	private void controlPlusSubMenu() {
		...
		mOverflowHelper.showAsDropDown(findViewById(com.jiujiu.ecdemo.R.id.btn_plus));
	}
...
//		MobclickAgent.onPause(this);
	...
	public void onClick(View v) {
		if (v.getId() == com.jiujiu.ecdemo.R.id.btn_plus) {
			controlPlusSubMenu();
		}
	}
	...
	private final AdapterView.OnItemClickListener mOverflowItemCliclListener = new AdapterView.OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> parent, View view, int position,
			...
			if (getString(com.jiujiu.ecdemo.R.string.main_plus_inter_phone).equals(title)) {
				// 实时对讲
				startActivity(new Intent(LauncherActivity.this,
						InterPhoneListActivity.class));
			} else if (getString(com.jiujiu.ecdemo.R.string.main_plus_meeting_voice).equals(title)) {
				// 语音会议
				startActivity(new Intent(LauncherActivity.this,
						MeetingListActivity.class));
			} else if (getString(com.jiujiu.ecdemo.R.string.main_plus_groupchat).equals(title)) {
				// 创建群组
				startActivity(new Intent(LauncherActivity.this, CreateGroupActivity.class));
			} else if (getString(com.jiujiu.ecdemo.R.string.main_plus_querygroup).equals(title)) {
				// 群组搜索
				startActivity(new Intent(LauncherActivity.this,BaseSearch.class));
			} else if (getString(com.jiujiu.ecdemo.R.string.main_plus_mcmessage).equals(title)) {
				handleStartServiceEvent();
				
			} else if (getString(com.jiujiu.ecdemo.R.string.main_plus_settings).equals(title)) {
				// 设置;
				startActivity(new Intent(LauncherActivity.this,SettingsActivity.class));
				
				
			} else if (getString(com.jiujiu.ecdemo.R.string.main_plus_meeting_video).equals(title)) {
				startActivity(new Intent(LauncherActivity.this,
						VideoconferenceConversation.class));

			}else if(getString(com.jiujiu.ecdemo.R.string.create_discussion).equals(title)){
			...
			}else if(getString(com.jiujiu.ecdemo.R.string.query_discussion).equals(title)){
			...
			}else if(getString(com.jiujiu.ecdemo.R.string.main_plus_money).equals(title)){
	...
	private void showUpdaterTips(String updateDesc ,final boolean force) {
		...
		String negativeText = getString(force ? com.jiujiu.ecdemo.R.string.settings_logout : com.jiujiu.ecdemo.R.string.update_next);
		String msg = getString(com.jiujiu.ecdemo.R.string.new_update_version);
		if(!TextUtils.isEmpty(updateDesc)) {
			msg = updateDesc;
		}
		showUpdaterTipsDialog = ECAlertDialog.buildAlert(this, msg,
				negativeText, getString(com.jiujiu.ecdemo.R.string.app_update),
				new DialogInterface.OnClickListener() {
		...
		showUpdaterTipsDialog.setTitle(com.jiujiu.ecdemo.R.string.app_tip);
