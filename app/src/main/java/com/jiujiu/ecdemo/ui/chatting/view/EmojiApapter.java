...
public class EmojiApapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null || convertView.getTag() == null ) {
            ...
            convertView=mInflater.inflate(com.jiujiu.ecdemo.R.layout.emoji_item, null);
            viewHolder.emoji_icon=(ImageView)convertView.findViewById(com.jiujiu.ecdemo.R.id.emoji_id);
        ...
        if(getCount() - 1 == position) {
    		viewHolder.emoji_icon.setImageResource(com.jiujiu.ecdemo.R.drawable.emoji_del_selector);
        } else {
        	
        	CCPEmoji emoji=(CCPEmoji) getItem(position);
        	if(emoji != null) {
        		if(emoji.getId() == com.jiujiu.ecdemo.R.drawable.emoji_del_selector) {
