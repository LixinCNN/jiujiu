...
public class CCPMaskLayout extends RelativeLayout {
	...
	public CCPMaskLayout(Context context, AttributeSet attrs, int defStyle) {
		...
		TypedArray styledAttributes = context.obtainStyledAttributes(attrs, com.jiujiu.ecdemo.R.styleable.MaskLayout, defStyle, 0);
	...
	protected void onFinishInflate() {
		...
		mView = findViewById(com.jiujiu.ecdemo.R.id.content);
		if(mView == null) {
