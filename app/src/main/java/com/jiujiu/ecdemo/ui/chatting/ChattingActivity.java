...
public class ChattingActivity extends ECFragmentActivity implements
	...
	protected void onResume() {
		...
		filter1.addAction("com.jiujiu.ecdemo.removemember");
		...
		public void onReceive(Context arg0, Intent intent)
		{
			...
			if (intent.getAction().equals(SDKCoreHelper.ACTION_KICK_OFF)
					|| intent.getAction().equals(
							"com.jiujiu.ecdemo.removemember"))
				finish();
		}
	}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.jiujiu.ecdemo.R.layout.chattingui_activity_container);
		...
		getSupportFragmentManager().beginTransaction()
				.add(com.jiujiu.ecdemo.R.id.ccp_root_view, mChattingFragment).commit();
		onActivityCreate();
