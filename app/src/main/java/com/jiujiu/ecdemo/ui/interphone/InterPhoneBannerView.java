...
public class InterPhoneBannerView extends LinearLayout {
    ...
    private void initBannerView() {
        View.inflate(getContext(), com.jiujiu.ecdemo.R.layout.ec_inter_phone_banner, this);
        mTipsView = (TextView) findViewById(com.jiujiu.ecdemo.R.id.notice_tips);
        mCountView = (TextView) findViewById(com.jiujiu.ecdemo.R.id.count_tv);
        mPersonView = (ImageView) findViewById(com.jiujiu.ecdemo.R.id.ic_person);
    }
