...
public abstract class VideoconferenceBaseActivity extends ECSuperActivity {
	...
	public boolean checkSDK() {
		if (ECDevice.getECMeetingManager() == null) {
			...
			ToastUtil.showMessage(com.jiujiu.ecdemo.R.string.SDK_INIT_FAILED);
			return false;
		}
		return true;
	}
		...
		if (!TextUtils.isEmpty(posButton)) {
			builder.setPositiveButton(posButton, new OnClickListener() {
				...
				public void onClick(DialogInterface dialog, int which) {
					...
					dialog.dismiss();
					if (!posButton
							.equals(getString(com.jiujiu.ecdemo.R.string.dialog_cancle_btn)))
	...
	public void setVideoTitleBackground() {
		findViewById(com.jiujiu.ecdemo.R.id.nav_title).setBackgroundResource(
				com.jiujiu.ecdemo.R.drawable.video_title_bg);
	}

	public void setVideoTitle(String title) {
		((TextView) findViewById(com.jiujiu.ecdemo.R.id.title)).setText(title);
	}
	...
	public void showVoIPWifiWarnning() {
		showAlertTipsDialog(DIALOG_REQUEST_VOIP_NOT_WIFI_WARNNING,
				getString(com.jiujiu.ecdemo.R.string.voip_not_wifi_warnning_title),
				getString(com.jiujiu.ecdemo.R.string.voip_not_wifi_warnning_message),
				getString(com.jiujiu.ecdemo.R.string.dialog_btn),
				getString(com.jiujiu.ecdemo.R.string.dialog_cancle_btn));
	}

	public void showNetworkNotAvailable() {
		showAlertTipsDialog(DIALOG_REQUEST_LOAD_FAILED_NETWORK,
				getString(com.jiujiu.ecdemo.R.string.voip_not_wifi_warnning_title),
				getString(com.jiujiu.ecdemo.R.string.load_failed_network),
