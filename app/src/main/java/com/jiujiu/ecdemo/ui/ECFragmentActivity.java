...
public class ECFragmentActivity extends FragmentActivity
    ...
    private void onStartActivityAction(Intent intent) {
        if(intent == null) {
            super.overridePendingTransition(com.jiujiu.ecdemo.R.anim.slide_right_in, com.jiujiu.ecdemo.R.anim.slide_left_out);
            return ;
        }
    ...
    public boolean onActivityCreate() {
        if(isSupperSwipe()) {
            ...
            mSwipeBackLayout = (SwipeBackLayout) LayoutInflater.from(this).inflate(
                    com.jiujiu.ecdemo.R.layout.swipeback_layout, viewGroup , false);
            mSwipeBackLayout.init();
            getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
            getWindow().getDecorView().setBackgroundDrawable(null);
            ViewGroup childAtView = (ViewGroup)viewGroup.getChildAt(0);
            childAtView.setBackgroundResource(com.jiujiu.ecdemo.R.drawable.transparent);
    ...
    public static class WindowAnimation {
        ...
        static {
            if(!(SDKVersionUtils.isSmallerVersion(19) && SupportSwipeModeUtils.isEnable())) {
                activityOpenEnterAnimation = com.jiujiu.ecdemo.R.anim.slide_right_in;
                activityOpenExitAnimation  = com.jiujiu.ecdemo.R.anim.slide_left_out;
                activityCloseEnterAnimation = com.jiujiu.ecdemo.R.anim.slide_left_in;
                activityCloseExitAnimation = com.jiujiu.ecdemo.R.anim.slide_right_out;
            } else {
                activityOpenEnterAnimation = com.jiujiu.ecdemo.R.anim.pop_in;
                activityOpenExitAnimation  = com.jiujiu.ecdemo.R.anim.anim_not_change;
                activityCloseEnterAnimation = com.jiujiu.ecdemo.R.anim.anim_not_change;
                activityCloseExitAnimation = com.jiujiu.ecdemo.R.anim.pop_out;
            }
        }
    }
}
