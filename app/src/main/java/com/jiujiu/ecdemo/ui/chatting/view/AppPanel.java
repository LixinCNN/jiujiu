...
public class AppPanel extends LinearLayout implements CCPFlipper.OnFlipperPageListener
	...
	private void initAppPanel() {
		...
		View.inflate(getContext(), com.jiujiu.ecdemo.R.layout.app_panel, this);
		mFlipper = (CCPFlipper) findViewById(com.jiujiu.ecdemo.R.id.app_panel_flipper);
		mDotView = (CCPDotView) findViewById(com.jiujiu.ecdemo.R.id.app_panel_dot);
	...
	private void initAppGrid() {
		...
		for(int i = 0; i < pageCount ; i ++) {
			AppGrid appGrid = (AppGrid) inflate(getContext(), com.jiujiu.ecdemo.R.layout.app_grid, null);
	...
	public final void initFlipperRotateMe() {
		if(mAppPanelHeightChange) {
			...
			View panelDisplayView = findViewById(com.jiujiu.ecdemo.R.id.app_panel_display_view);
