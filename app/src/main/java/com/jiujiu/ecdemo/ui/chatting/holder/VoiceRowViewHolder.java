...
import com.jiujiu.ecdemo.ui.chatting.view.CCPAnimImageView;
...
public class VoiceRowViewHolder extends BaseHolder {
    ...
    public BaseHolder initBaseHolder(View baseView , boolean receive) {
        ...
        voicePlayAnim = ((TextView) baseView.findViewById(com.jiujiu.ecdemo.R.id.chatting_voice_play_anim_tv));
        ...
        contentTv = ((TextView) baseView.findViewById(com.jiujiu.ecdemo.R.id.chatting_content_itv));
        voicePlayFrameLayout = ((FrameLayout) baseView.findViewById(com.jiujiu.ecdemo.R.id.chatting_voice_play_content));
        voiceAnim = ((CCPAnimImageView) baseView.findViewById(com.jiujiu.ecdemo.R.id.chatting_voice_anim));
        ...
        if (receive) {
            ...
            voiceLoading = ((CCPAnimImageView) baseView.findViewById(com.jiujiu.ecdemo.R.id.chatting_voice_loading));
            voiceLoading.setVoiceFrom(true);
            voiceLoading.restBackground();
            return this;
        }

        voiceSending = ((ProgressBar) baseView.findViewById(com.jiujiu.ecdemo.R.id.chatting_voice_sending));
        progressBar = ((ProgressBar) baseView.findViewById(com.jiujiu.ecdemo.R.id.uploading_pb));
        voiceSendigBG = ((TextView) baseView.findViewById(com.jiujiu.ecdemo.R.id.chatting_voice_sending_bg));
    ...
    public static void initVoiceRow(VoiceRowViewHolder holder , ECMessage detail , int position , ChattingActivity activity , boolean receive) {
        ...
        if(adapterForce.mVoicePosition == position) {
            ...
            holder.contentTv.setText(activity.getString(com.jiujiu.ecdemo.R.string.fmt_time_length, duration));
        ...
        if(!receive) {
            holder.voiceAnim.setBackgroundResource(com.jiujiu.ecdemo.R.drawable.chatto_bg);
            holder.voicePlayAnim.setBackgroundResource(com.jiujiu.ecdemo.R.drawable.chatto_bg);
        } else {
            holder.voiceAnim.setBackgroundResource(com.jiujiu.ecdemo.R.drawable.chatfrom_bg);
            holder.voicePlayAnim.setBackgroundResource(com.jiujiu.ecdemo.R.drawable.chatfrom_bg);
        }
