...
public class FileRowViewHolder extends BaseHolder {
	...
	public BaseHolder initBaseHolder(View baseView , boolean receive) {
		...
		ivVideoMp4=(ImageView) baseView.findViewById(com.jiujiu.ecdemo.R.id.iv_file_mp4);
		fl=(FrameLayout) baseView.findViewById(com.jiujiu.ecdemo.R.id.fl_chatting_video);
		buPlayVideo=(Button) baseView.findViewById(com.jiujiu.ecdemo.R.id.btn_play_video);
		tvFile=(TextView) baseView.findViewById(com.jiujiu.ecdemo.R.id.tv_filesize);
		if(!receive){
