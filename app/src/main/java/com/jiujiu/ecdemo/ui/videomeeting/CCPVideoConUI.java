...
public class CCPVideoConUI extends LinearLayout {
	...
	private FrameLayout getImageViewLayout(int space , final int layoutKye) {
		FrameLayout fLayout = (FrameLayout) mLayoutInflater.inflate(com.jiujiu.ecdemo.R.layout.video_c_item, null);
		LayoutParams rfLayoutParams = new LayoutParams(LayoutParams.MATCH_PARENT
				, LayoutParams.MATCH_PARENT);
		rfLayoutParams.gravity = Gravity.CENTER_HORIZONTAL;
		rfLayoutParams.weight = 1;

		TextView textViewImage = (TextView) fLayout.findViewById(com.jiujiu.ecdemo.R.id.image);
		TextView textView = (TextView) fLayout.findViewById(com.jiujiu.ecdemo.R.id.text);
		...
		fLayout.setBackgroundResource(com.jiujiu.ecdemo.R.color.black);
		fLayout.getBackground().setAlpha(55);

		textView.getBackground().setAlpha(55);

		drawableR = getResources().getDrawable(com.jiujiu.ecdemo.R.drawable.three_point);
	...
	private FrameLayout getSurfaceViewLayout(int space , final int layoutKye) {
		FrameLayout lframeLayout = (FrameLayout) mLayoutInflater.inflate(com.jiujiu.ecdemo.R.layout.video_c_local_surceview, null);
		...
		SurfaceView surfaceView = (SurfaceView) lframeLayout.findViewById(com.jiujiu.ecdemo.R.id.surface_view);
		TextView textView = (TextView) lframeLayout.findViewById(com.jiujiu.ecdemo.R.id.text);
		...
		lframeLayout.setBackgroundResource(com.jiujiu.ecdemo.R.color.black);
	...
	* @param drawable
	...
	public void setImageViewDrawable(int index , Drawable drawable) {
		...
		if(drawable == null) {
			text = "待加入";
			view.setBackgroundColor(mContext.getResources().getColor(com.jiujiu.ecdemo.R.color.black));
	...
	* @param drawable
	...
	public void setImageViewDrawableLoading(int index , String text , Drawable drawable) {
		...
		TextView textView = (TextView)view.findViewById(com.jiujiu.ecdemo.R.id.image);
	...
	public void setVideoUIMainScreen(int index) {
		...
		if(mVideoUIMainKey != -1) {
			...
			if(viewMainSrc != null) {
				viewMainSrc.setBackgroundColor(mContext.getResources().getColor(com.jiujiu.ecdemo.R.color.black));
	...
	* @param Operable
	...
	public void setVideoUIText(final int index , CharSequence textView , boolean Operable) {
		...
		View view = videoLayoutCache.get(index);
		TextView tempTextView = ((TextView)view.findViewById(com.jiujiu.ecdemo.R.id.text));
	...
	* @return
	...
	public String getVideoUIText(int index) {
		View view = videoLayoutCache.get(index);
		CharSequence text = ((TextView) view.findViewById(com.jiujiu.ecdemo.R.id.text)).getText();
