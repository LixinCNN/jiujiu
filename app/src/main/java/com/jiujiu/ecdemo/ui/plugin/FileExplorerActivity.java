 ...
 */
package com.jiujiu.ecdemo.ui.plugin;
...
public class FileExplorerActivity extends ECSuperActivity implements
	...
	protected int getLayoutId() {
		return com.jiujiu.ecdemo.R.layout.file_explorer;
	}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(TextUtils.isEmpty(title)) {
			getTopBarView().setTopBarToStatus(1, com.jiujiu.ecdemo.R.drawable.topbar_back_bt, -1, com.jiujiu.ecdemo.R.string.plugin_file_explorer_ui_title, this);
		} else {
			getTopBarView().setTopBarToStatus(1, com.jiujiu.ecdemo.R.drawable.topbar_back_bt, -1, title, this);
		}
	...
	private void initFileExplorer() {
		mFileListView = (ListView) findViewById(com.jiujiu.ecdemo.R.id.file_explorer_list_lv);
		mRootTab = (TextView) findViewById(com.jiujiu.ecdemo.R.id.root_tab);
		mRootTabSelector = findViewById(com.jiujiu.ecdemo.R.id.root_tab_selector);
		mSdcardTab = (TextView) findViewById(com.jiujiu.ecdemo.R.id.sdcard_tab);
		mSdcardTabSelector = findViewById(com.jiujiu.ecdemo.R.id.sdcard_tab_selector);
		
		mFileExplorerRootTag = getString(com.jiujiu.ecdemo.R.string.plugin_file_explorer_root_tag);
		mFileExplorerSdcardTag = getString(com.jiujiu.ecdemo.R.string.plugin_file_explorer_sdcard_tag);
	...
	private void setCurrentTabSelector(int type) {
		mType = type;
		if (type == DIR_SDCARD) {
			mSdcardTab.setTextColor(getResources().getColor(com.jiujiu.ecdemo.R.color.red_btn_color_normal));
			mRootTab.setTextColor(getResources().getColor(com.jiujiu.ecdemo.R.color.action_bar_tittle_color));
			mRootTabSelector.setVisibility(View.GONE);
			mSdcardTabSelector.setVisibility(View.VISIBLE);
			return;
		}
		mRootTab.setTextColor(getResources().getColor(com.jiujiu.ecdemo.R.color.red_btn_color_normal));
		mSdcardTab.setTextColor(getResources().getColor(com.jiujiu.ecdemo.R.color.action_bar_tittle_color));
