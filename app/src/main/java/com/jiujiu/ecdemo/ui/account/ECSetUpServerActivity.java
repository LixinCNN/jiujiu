...
public class ECSetUpServerActivity extends ECSuperActivity implements
	...
	protected int getLayoutId() {
		...
		return com.jiujiu.ecdemo.R.layout.setup_server_layout;
	}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		getTopBarView().setTopBarToStatus(1, com.jiujiu.ecdemo.R.drawable.topbar_back_bt,
				com.jiujiu.ecdemo.R.drawable.btn_style_green, null, "重置配置",
				getString(com.jiujiu.ecdemo.R.string.setup_server), null, this);
	...
	private void initViews() {
		...
		etConnect = (EditText) findViewById(com.jiujiu.ecdemo.R.id.setup_connect);
		etConnectPort = (EditText) findViewById(com.jiujiu.ecdemo.R.id.setup_connect_port);
		etLVS = (EditText) findViewById(com.jiujiu.ecdemo.R.id.setup_lvs);
		etLVSPort = (EditText) findViewById(com.jiujiu.ecdemo.R.id.setup_lvs_port);
		etFile = (EditText) findViewById(com.jiujiu.ecdemo.R.id.setup_fileserver);
		etFilePort = (EditText) findViewById(com.jiujiu.ecdemo.R.id.setup_fileserver_port);
		etAppid = (EditText) findViewById(com.jiujiu.ecdemo.R.id.setup_appid);
		etAppToken = (EditText) findViewById(com.jiujiu.ecdemo.R.id.setup_apptoken);
		etSetName = (EditText) findViewById(com.jiujiu.ecdemo.R.id.setup_name);
		buSetApp=(Button)findViewById(com.jiujiu.ecdemo.R.id.set_app_button);
		buSetIp=(Button)findViewById(com.jiujiu.ecdemo.R.id.set_ip_button);
		buModify=(Button)findViewById(com.jiujiu.ecdemo.R.id.bu_modify_item);

		buSetAll= (Button) findViewById(com.jiujiu.ecdemo.R.id.set_all_button);
		buAddServerList= (Button) findViewById(com.jiujiu.ecdemo.R.id.bu_add_setupserver);
		buQueryServerList= (Button) findViewById(com.jiujiu.ecdemo.R.id.bu_query_serverlist);
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case com.jiujiu.ecdemo.R.id.bu_add_setupserver:

			logicAddServerItem();

			break;
		case com.jiujiu.ecdemo.R.id.bu_query_serverlist:


			startActivityForResult(new Intent(this, ECServerConfigListUI.class),1);
			break;
		case com.jiujiu.ecdemo.R.id.set_all_button:
		...
		case com.jiujiu.ecdemo.R.id.bu_modify_item:
		...
		case com.jiujiu.ecdemo.R.id.btn_left:
			...
			case com.jiujiu.ecdemo.R.id.set_app_button:
				setApp();
				break;
			case com.jiujiu.ecdemo.R.id.set_ip_button:
			setIp();
					break;
