...
import com.jiujiu.ecdemo.ui.chatting.base.emoji.Objects;
...
public class VoiceMeetingMicAnim extends LinearLayout implements Runnable {
    ...
    protected void onFinishInflate() {
        ...
        mLeftAmplitude = (LinearLayout) findViewById(com.jiujiu.ecdemo.R.id.chatroom_l_status);
        mRightAmplitude = (LinearLayout) findViewById(com.jiujiu.ecdemo.R.id.chatroom_r_status);
        mMikeView = (ImageView) findViewById(com.jiujiu.ecdemo.R.id.chatroom_mike);
    ...
    synchronized void  initBottomStatus(int num){//4
        ...
        for (int i = 0; i < 6; i++) {
            ...
            if(i > (6 - num - 1)) {//1
                imageViewl_i.setImageResource(com.jiujiu.ecdemo.R.drawable.chatroom_speaker);
            } else {
                imageViewl_i.setImageResource(com.jiujiu.ecdemo.R.drawable.chatroom_unspeaker);

            }
            if(i >= num) {//4
                imageViewR_i.setImageResource(com.jiujiu.ecdemo.R.drawable.chatroom_unspeaker);
            } else {
                imageViewR_i.setImageResource(com.jiujiu.ecdemo.R.drawable.chatroom_speaker);
            }
