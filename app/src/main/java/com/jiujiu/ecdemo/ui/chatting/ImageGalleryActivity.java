...
public class ImageGalleryActivity extends ECSuperActivity implements View.OnClickListener{
    ...
    private void initResourceRefs() {
        mImageView = (ImageView) findViewById(com.jiujiu.ecdemo.R.id.image_photo);
        mImageView.setOnClickListener(this);
        mpProgressBar = (ProgressBar) findViewById(com.jiujiu.ecdemo.R.id.footLoading);
    ...
    protected int getLayoutId() {
        ...
        return com.jiujiu.ecdemo.R.layout.slide_image;
    }
