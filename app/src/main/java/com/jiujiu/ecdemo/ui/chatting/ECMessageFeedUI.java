...
public class ECMessageFeedUI extends ECSuperActivity implements View.OnClickListener,XListView.IXListViewListener, NetUtils.ResultCallBack {
    ...
    protected int getLayoutId() {
        return com.jiujiu.ecdemo.R.layout.message_feed;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv =(XListView) findViewById(com.jiujiu.ecdemo.R.id.feed_list);
    ...
    private  class FeedBackAdapter extends ArrayAdapter<ECReadMessageMember>{
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
               View v = View.inflate(ECMessageFeedUI.this, com.jiujiu.ecdemo.R.layout.message_feedback_item,null);
                   TextView accountTv= (TextView) v.findViewById(com.jiujiu.ecdemo.R.id.messageAccount);
