...
public class ChattingItemContainer extends RelativeLayout {
	...
	public ChattingItemContainer(LayoutInflater inflater , int resource ) {
		...
		TextView textView = new TextView(getContext(), null, com.jiujiu.ecdemo.R.style.ChattingUISplit);
		textView.setId(com.jiujiu.ecdemo.R.id.chatting_time_tv);
		...
		textViewLayoutParams.setMargins(0, getResources().getDimensionPixelSize(com.jiujiu.ecdemo.R.dimen.NormalPadding), 0,
				getResources().getDimensionPixelSize(com.jiujiu.ecdemo.R.dimen.NormalPadding));
		...
		if(id == -1) {
			...
			id = com.jiujiu.ecdemo.R.id.chatting_content_area;
		...
		LayoutParams chattingViewLayoutParams = new  LayoutParams(
				 ...
				 LayoutParams.WRAP_CONTENT);
		 chattingViewLayoutParams.addRule(RelativeLayout.BELOW, com.jiujiu.ecdemo.R.id.chatting_time_tv);
		 chattingViewLayoutParams.addRule(RelativeLayout.LEFT_OF, com.jiujiu.ecdemo.R.id.chatting_checkbox);
		 addView(chattingView, chattingViewLayoutParams);
		 
		 View maskView = new View(getContext());
		 maskView.setId(com.jiujiu.ecdemo.R.id.chatting_maskview);
