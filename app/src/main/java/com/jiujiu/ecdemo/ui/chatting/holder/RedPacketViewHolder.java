...
public class RedPacketViewHolder extends BaseHolder {
    ...
    public BaseHolder initBaseHolder(View baseView, boolean receive) {
        ...
        tv_money_greeting = (TextView) baseView.findViewById(com.jiujiu.ecdemo.R.id.tv_money_greeting);
        tv_sponsor_name = (TextView) baseView.findViewById(com.jiujiu.ecdemo.R.id.tv_sponsor_name);
        tv_packet_type = (TextView) baseView.findViewById(com.jiujiu.ecdemo.R.id.tv_packet_type);
        bubble = (RelativeLayout) baseView.findViewById(com.jiujiu.ecdemo.R.id.bubble);
...
//        progressBar = (ProgressBar) baseView.findViewById(R.id.uploading_pb);
    ...
    public TextView getGreetingTv() {
        if (tv_money_greeting == null) {
            tv_money_greeting = (TextView) getBaseView().findViewById(com.jiujiu.ecdemo.R.id.tv_money_greeting);
        }
    ...
    public TextView getSponsorNameTv() {
        if (tv_sponsor_name == null) {
            tv_sponsor_name = (TextView) getBaseView().findViewById(com.jiujiu.ecdemo.R.id.tv_sponsor_name);
        }
    ...
    public TextView getPacketTypeTv() {
        if (tv_packet_type == null) {
            tv_packet_type = (TextView) getBaseView().findViewById(com.jiujiu.ecdemo.R.id.tv_packet_type);
        }
    ...
    public RelativeLayout getBubble() {
        if (bubble == null) {
            bubble = (RelativeLayout) getBaseView().findViewById(com.jiujiu.ecdemo.R.id.bubble);
        }
        return bubble;
    }
