...
public abstract class CCPActivityBase {
    ...
    public void init(Context context , FragmentActivity activity)  {
        ...
        mBaseLayoutView = mLayoutInflater.inflate(com.jiujiu.ecdemo.R.layout.ccp_activity, null);
        mTransLayerView = mBaseLayoutView.findViewById(com.jiujiu.ecdemo.R.id.ccp_trans_layer);
        LinearLayout mRootView = (LinearLayout) mBaseLayoutView.findViewById(com.jiujiu.ecdemo.R.id.ccp_root_view);
        mContentFrameLayout = (FrameLayout) mBaseLayoutView.findViewById(com.jiujiu.ecdemo.R.id.ccp_content_fl);
        ...
        CCPLayoutListenerView listenerView = (CCPLayoutListenerView) mActionBarActivity.findViewById(com.jiujiu.ecdemo.R.id.ccp_content_fl);
    ...
    public final void setActionContentDescription(CharSequence contentDescription) {
        ...
        String description = mActionBarActivity.getString(com.jiujiu.ecdemo.R.string.common_enter_activity) + contentDescription;
    ...
    public int getTitleLayout() {
        return com.jiujiu.ecdemo.R.layout.ec_title_view_base;
    }
    ...
    protected SpannableString buildActionTitle() {
        int dimensionPixelSize = mActionBarActivity.getResources().getDimensionPixelSize(com.jiujiu.ecdemo.R.dimen.BigTextSize);
        ...
        if(isMute) {
            if(mMuteIcon == null) {
                mMuteIcon = getTitleIconTips(dimensionPixelSize, com.jiujiu.ecdemo.R.drawable.chat_mute_notify_title_icon);
            }
