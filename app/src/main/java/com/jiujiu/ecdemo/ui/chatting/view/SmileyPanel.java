...
public class SmileyPanel extends ChatFooterPanel implements
	...
	public SmileyPanel(Context context, AttributeSet attrs) {
		...
		inflate(context, com.jiujiu.ecdemo.R.layout.ccp_smile_panel, this);
		
		mFlipper = ((CCPFlipper) findViewById(com.jiujiu.ecdemo.R.id.smiley_panel_flipper));
		mDotView = ((CCPDotView) findViewById(com.jiujiu.ecdemo.R.id.smiley_panel_dot));
		initEmojiPanel();
	}
	...
	private void initEmojiPanel(){
		...
		View smileyPanelDisplayView = findViewById(com.jiujiu.ecdemo.R.id.smiley_panel_display_view);
