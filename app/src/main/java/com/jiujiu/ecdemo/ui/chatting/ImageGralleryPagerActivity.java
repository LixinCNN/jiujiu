...
public class ImageGralleryPagerActivity extends ECSuperActivity implements View.OnClickListener{
    ...
    protected int getLayoutId() {
        return com.jiujiu.ecdemo.R.layout.image_grallery_container;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getTopBarView().setTopBarToStatus(1, com.jiujiu.ecdemo.R.drawable.topbar_back_bt, -1, "1 / 1", this);
        ...
        mPager = (HackyViewPager) findViewById(com.jiujiu.ecdemo.R.id.pager);
        final ImagePagerAdapter mAdapter = new ImagePagerAdapter(getSupportFragmentManager(), urls);
        mPager.setAdapter(mAdapter);
        indicator = (TextView) findViewById(com.jiujiu.ecdemo.R.id.indicator);
        findViewById(com.jiujiu.ecdemo.R.id.imagebrower_iv_save).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(mAdapter != null) {
                    ViewImageInfo viewImageInfo = urls.get(mPager.getCurrentItem());
                    if(viewImageInfo == null || !viewImageInfo.isDownload()) {
                        ToastUtil.showMessage(com.jiujiu.ecdemo.R.string.save_img_waite_download);
                        return ;
                    }
                    try {
        ...
        if(mAdapter!=null){
        	...
        	if(viewImageInfoItem!=null&& IMessageSqlManager.isFireMsg(viewImageInfoItem.getMsgLocalId())){
        		findViewById(com.jiujiu.ecdemo.R.id.imagebrower_iv_save).setVisibility(View.GONE);
        	}else {
        		findViewById(com.jiujiu.ecdemo.R.id.imagebrower_iv_save).setVisibility(View.GONE);
    ...
    private void initIndicatorIndex(int arg0) {
        CharSequence text = getString(com.jiujiu.ecdemo.R.string.viewpager_indicator, arg0 + 1, mPager.getAdapter().getCount());
