...
public class SingleView extends LinearLayout implements Checkable {
	...
	private void initView(Context context){
		...
		View v = inflater.inflate(com.jiujiu.ecdemo.R.layout.item_single_layout, this, true);
		mText = (TextView) v.findViewById(com.jiujiu.ecdemo.R.id.title);
		mCheckBox = (CheckBox) v.findViewById(com.jiujiu.ecdemo.R.id.checkbox);
	}
