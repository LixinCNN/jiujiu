...
public class InterPhoneMicController extends FrameLayout implements View.OnTouchListener {
    ...
    private void initView() {
        mInterSpeak = (Button) findViewById(com.jiujiu.ecdemo.R.id.inter_phone_speak);
    ...
    public void setControlMicType(MicType type) {
        ...
        if(type == MicType.CONTROL) {
            ...
            mChronometer.start();
            mChronometer.setVisibility(View.VISIBLE);
            mInterSpeak.setBackgroundResource(com.jiujiu.ecdemo.R.drawable.voice_intephone_connect) ;
            return ;
        }
        ...
        if(isDownEvent) {
            mInterSpeak.setBackgroundResource(com.jiujiu.ecdemo.R.drawable.voice_intephone_failed) ;
        } else {
            mInterSpeak.setBackgroundResource(com.jiujiu.ecdemo.R.drawable.voice_intephone_normal) ;
        }
    }
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                mInterSpeak.setBackgroundResource(com.jiujiu.ecdemo.R.drawable.voice_intephone_pressed);
                if (mHandler != null ) {
