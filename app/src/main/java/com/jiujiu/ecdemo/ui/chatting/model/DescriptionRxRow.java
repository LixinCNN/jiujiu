...
import com.jiujiu.ecdemo.ui.chatting.holder.DescriptionViewHolder;
...
public class DescriptionRxRow extends BaseChattingRow {
	...
	public View buildChatView(LayoutInflater inflater, View convertView) {
        ...
        if (convertView == null ) {
            convertView = new ChattingItemContainer(inflater, com.jiujiu.ecdemo.R.layout.chatting_item_from);
		...
		if(message != null) {
			if (message.getType() == ECMessage.Type.TXT) {
				...
				if (TextUtils.equals(msgType, CCPChattingFooter2.FACETYPE)) {
					...
					holder.getDescTextView().setBackgroundResource(com.jiujiu.ecdemo.R.drawable.chat_from_bg_normal);
				}
