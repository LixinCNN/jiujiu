...
public class CCPAnimImageView extends TextView {
	...
	public void initCCPAnimImageView() {
		...
		Drawable chattingFDrawale1 = getResources().getDrawable(com.jiujiu.ecdemo.R.drawable.chatfrom_voice_playing_f1);
		...
		Drawable chattingFDrawale2 = getResources().getDrawable(com.jiujiu.ecdemo.R.drawable.chatfrom_voice_playing_f2);
		...
		Drawable chattingFDrawale3 = getResources().getDrawable(com.jiujiu.ecdemo.R.drawable.chatfrom_voice_playing_f3);
		...
		Drawable chattingTDrawable_1 = getResources().getDrawable(com.jiujiu.ecdemo.R.drawable.chatto_voice_playing_f1);
		...
		Drawable chattingTDrawable_2 = getResources().getDrawable(com.jiujiu.ecdemo.R.drawable.chatto_voice_playing_f2);
		...
		Drawable chattingTDrawable_3 = getResources().getDrawable(com.jiujiu.ecdemo.R.drawable.chatto_voice_playing_f3);
	...
	public final void startVoiceAnimation() {
		...
		case TYPE_VOICE_DOWNLOADING:
			...
			if(isFrom) {
				setBackgroundDrawable(mActivity.getResources().getDrawable(com.jiujiu.ecdemo.R.drawable.chatfrom_bg_voice_downloading));
			} else {
				setBackgroundDrawable(mActivity.getResources().getDrawable(com.jiujiu.ecdemo.R.drawable.chatto_bg_voice_downloading));
			}
	...
	public final void restBackground() {
		if(isFrom) {
			setBackgroundDrawable(getResources().getDrawable(com.jiujiu.ecdemo.R.drawable.chatfrom_bg));
			return;
		}
		setBackgroundDrawable(getResources().getDrawable(com.jiujiu.ecdemo.R.drawable.chatto_bg));
	}
