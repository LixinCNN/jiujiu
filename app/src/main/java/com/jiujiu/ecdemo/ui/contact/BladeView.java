...
public class BladeView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < b.length; i++) {
            ...
            paint.setTextSize(getResources().getDimensionPixelSize(com.jiujiu.ecdemo.R.dimen.bladeview_fontsize));//设置字体的大小
    ...
    private void showPopup(int item) {
        if (mPopupWindow == null) {
            ...
            mPopupText.setTextSize(getResources().getDimensionPixelSize(com.jiujiu.ecdemo.R.dimen.bladeview_popup_fontsize));
            mPopupText.setGravity(Gravity.CENTER_HORIZONTAL
                    | Gravity.CENTER_VERTICAL);

            int height = getResources().getDimensionPixelSize(com.jiujiu.ecdemo.R.dimen.bladeview_popup_height);
