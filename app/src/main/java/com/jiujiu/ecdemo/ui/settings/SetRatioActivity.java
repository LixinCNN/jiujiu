...
import com.jiujiu.ecdemo.common.dialog.IBaseAdapter;
...
public class SetRatioActivity extends ECSuperActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		getTopBarView().setTopBarToStatus(1, com.jiujiu.ecdemo.R.drawable.topbar_back_bt,
				...
				getString(com.jiujiu.ecdemo.R.string.app_save_ratio),
				getString(com.jiujiu.ecdemo.R.string.app_set_ratio), null, this);

		listView = (ListView) findViewById(com.jiujiu.ecdemo.R.id.listView);
		  list = new ArrayList();
	...
	protected int getLayoutId() {
		return com.jiujiu.ecdemo.R.layout.activity_ratio;
	}
