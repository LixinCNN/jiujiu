...
public class CreateGroupActivity extends ECSuperActivity implements
	...
	protected int getLayoutId() {
		return com.jiujiu.ecdemo.R.layout.new_group;
	}

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		stringArray = getResources().getStringArray(com.jiujiu.ecdemo.R.array.group_join_model);
		
		groupCodeArray=getResources().getStringArray(com.jiujiu.ecdemo.R.array.create_group_type_code);
		groupContentArray=getResources().getStringArray(com.jiujiu.ecdemo.R.array.create_group_type_content);

		isDiscussion = getIntent().getBooleanExtra("is_discussion", false);

		int resId = com.jiujiu.ecdemo.R.string.app_title_create_new_group;
		if (isDiscussion) {
			resId = com.jiujiu.ecdemo.R.string.discussion_create;
		}
	...
	private void initView() {
		mNameEdit = (EditText) findViewById(com.jiujiu.ecdemo.R.id.group_name);

		mNoticeEdit = (EditText) findViewById(com.jiujiu.ecdemo.R.id.group_notice);
	mProviceEdit = (EditText) findViewById(com.jiujiu.ecdemo.R.id.group_provice);
	mCityEdit = (EditText) findViewById(com.jiujiu.ecdemo.R.id.group_city);
		
		buGroupType = (Button) findViewById(com.jiujiu.ecdemo.R.id.str_group_type);
		
		buGroupType.setOnClickListener(this);
		if (isDiscussion) {
			mNameEdit.setHint(com.jiujiu.ecdemo.R.string.discussion_name);
			mNoticeEdit.setHint(com.jiujiu.ecdemo.R.string.discussion_notice);
		}
		...
		mCreateBtn = (Button) findViewById(com.jiujiu.ecdemo.R.id.create);
		...
		mPermissionSpinner = (Spinner) findViewById(com.jiujiu.ecdemo.R.id.str_group_permission_spinner);
		
		
		
		ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(
				this, com.jiujiu.ecdemo.R.array.group_join_model,
		...
		mSetPermission = (Button) findViewById(com.jiujiu.ecdemo.R.id.str_group_permission_spinner2);
	...
	public void onClick(View v) {
		...
		case com.jiujiu.ecdemo.R.id.btn_left:
			...
			finish();
			break;
		case com.jiujiu.ecdemo.R.id.str_group_type:
			
			showGroupTypeDialog();
			break;
		case com.jiujiu.ecdemo.R.id.create:
			hideSoftKeyboard();
			...
			mPostingdialog = new ECProgressDialog(this,
					isDiscussion ? com.jiujiu.ecdemo.R.string.create_dis_posting
							: com.jiujiu.ecdemo.R.string.create_group_posting);
			mPostingdialog.show();
	...
	private boolean showPermissionDialog() {
		...
		dialog.setTitle(com.jiujiu.ecdemo.R.string.str_group_permission_spinner);
		dialog.show();
		return true;
	}
	private boolean showGroupTypeDialog() {
		...
		dialog.setTitle(com.jiujiu.ecdemo.R.string.str_group_permission_type);
		dialog.show();
		return true;
	}
