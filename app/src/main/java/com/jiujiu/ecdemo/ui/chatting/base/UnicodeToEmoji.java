...
import com.jiujiu.ecdemo.ui.chatting.base.emoji.BQMMEmoji;
...
public class UnicodeToEmoji {
    ...
    private static Map<Integer, BQMMEmoji> sEmojiMap;
    private static List<BQMMEmoji> sEmojiList;
    ...
    public static void initPhotos(Context context) {
        sEmojiMap = new HashMap<Integer, BQMMEmoji>();
        sEmojiList = new ArrayList<BQMMEmoji>();
        sResources = context.getResources();

        int[] codes = sResources.getIntArray(com.jiujiu.ecdemo.R.array.emoji_codes);
        TypedArray array = sResources.obtainTypedArray(com.jiujiu.ecdemo.R.array.emoji_res);
        ...
        while (++i < codes.length) {
            BQMMEmoji emoji = new BQMMEmoji(codes[i], array.getResourceId(i, -1));
