...
import com.jiujiu.ecdemo.ui.chatting.base.EmojiconEditText;
...
public class EditConfigureActivity extends ECSuperActivity implements View.OnClickListener{
    ...
    private void initView() {
        mEdittext = (EmojiconEditText) findViewById(com.jiujiu.ecdemo.R.id.content);
    ...
    protected int getLayoutId() {
        return com.jiujiu.ecdemo.R.layout.activity_edit_configure;
    }
