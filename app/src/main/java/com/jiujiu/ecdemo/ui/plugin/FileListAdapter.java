...
import com.jiujiu.ecdemo.common.utils.CnToCharUntil;
...
public class FileListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null || convertView.getTag() == null) {
			view = View.inflate(mContext, com.jiujiu.ecdemo.R.layout.file_explorer_item, null);

			mViewHolder = new ViewHolder();
			mViewHolder.mFileIcon = (ImageView) view.findViewById(com.jiujiu.ecdemo.R.id.file_icon_iv);
			mViewHolder.mFileName = (TextView) view.findViewById(com.jiujiu.ecdemo.R.id.file_name_tv);
			mViewHolder.mFileSummary = (TextView) view.findViewById(com.jiujiu.ecdemo.R.id.file_summary_tv);
		...
		if(file == mParentFile) {
			mViewHolder.mFileIcon.setImageResource(com.jiujiu.ecdemo.R.drawable.im_attach_back);
		} else {
			if(file.isDirectory()) {
				mViewHolder.mFileIcon.setImageResource(com.jiujiu.ecdemo.R.drawable.file_attach_folder);
			} else {
