...
public class ConversationListFragment extends TabFragment implements CCPListAdapter.OnListAdapterCallBackListener {
        ...
        if(conversation != null && conversation.getSessionId() != null) {
            ...
            if(conversation.getSessionId().toLowerCase().startsWith("g")) {
                ...
                if(ecGroup == null || !GroupSqlManager.getJoinState(ecGroup.getGroupId())) {
                    return new String[]{getString(com.jiujiu.ecdemo.R.string.main_delete)};
                }
                if(ecGroup.isNotice()) {
                    if(isTop) {
                        return new String[]{getString(com.jiujiu.ecdemo.R.string.main_delete) ,getString(com.jiujiu.ecdemo.R.string.cancel_top),getString(com.jiujiu.ecdemo.R.string.menu_mute_notify)};

                    }else {
                        return new String[]{getString(com.jiujiu.ecdemo.R.string.main_delete) ,getString(com.jiujiu.ecdemo.R.string.set_top),getString(com.jiujiu.ecdemo.R.string.menu_mute_notify)};
                    }
                }else {
                    if(isTop){
                        return new String[]{getString(com.jiujiu.ecdemo.R.string.main_delete) ,getString(com.jiujiu.ecdemo.R.string.cancel_top),getString(com.jiujiu.ecdemo.R.string.menu_notify)};
                    }else {
                        return new String[]{getString(com.jiujiu.ecdemo.R.string.main_delete) ,getString(com.jiujiu.ecdemo.R.string.set_top),getString(com.jiujiu.ecdemo.R.string.menu_notify)};
                ...
                if(isTop){
                    return new String[]{getString(com.jiujiu.ecdemo.R.string.main_delete) ,getString(com.jiujiu.ecdemo.R.string.cancel_top)};
                }else {
                    return new String[]{getString(com.jiujiu.ecdemo.R.string.main_delete) ,getString(com.jiujiu.ecdemo.R.string.set_top)};
    ...
    private void initView() {
        ...
        mListView = (ListView) findViewById(com.jiujiu.ecdemo.R.id.main_chatting_lv);
        View mEmptyView = findViewById(com.jiujiu.ecdemo.R.id.empty_conversation_tv);
    ...
    public void  updateConnectState() {
        ...
        if(connect == ECDevice.ECConnectState.CONNECTING) {
            mBannerView.setNetWarnText(getString(com.jiujiu.ecdemo.R.string.connecting_server));
            mBannerView.reconnect(true);
        } else if (connect == ECDevice.ECConnectState.CONNECT_FAILED) {
            mBannerView.setNetWarnText(getString(com.jiujiu.ecdemo.R.string.connect_server_error));
                ...
                case 2:
                    ...
                    GroupService.setGroupMessageOption(option, new GroupService.GroupOptionCallback() {
                        ...
                        public void onComplete(String groupId) {
                            ...
                            ToastUtil.showMessage(notify? com.jiujiu.ecdemo.R.string.new_msg_mute_notify : com.jiujiu.ecdemo.R.string.new_msg_notify);
                            dismissPostingDialog();
                        }
    ...
    protected int getLayoutId() {
        return com.jiujiu.ecdemo.R.layout.conversation;
    }
    ...
    void showProcessDialog() {
        mPostingdialog = new ECProgressDialog(ConversationListFragment.this.getActivity(), com.jiujiu.ecdemo.R.string.login_posting_submit);
        mPostingdialog.show();
    }
