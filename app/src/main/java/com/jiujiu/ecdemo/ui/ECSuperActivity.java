...
import com.jiujiu.ecdemo.common.ActivityTaskUtils;
...
public abstract class ECSuperActivity extends ECFragmentActivity implements GestureDetector.OnGestureListener{
    ...
    private int getMinExitScrollX() {
        if (this.mMinExitScrollX == 0) {
            this.mMinExitScrollX = (int) (getResources().getInteger(com.jiujiu.ecdemo.R.integer.min_exit_scroll_factor) * getWidthPixels() / 100.0F);
    ...
    public void showCommonProcessDialog(String tips) {
		mPostingdialog = new ECProgressDialog(this, com.jiujiu.ecdemo.R.string.progress_common);
		mPostingdialog.show();
	}
