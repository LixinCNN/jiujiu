...
public class VoIPCallActivity extends ECVoIPBaseActivity /*implements ECVoIPCallManager.OnCallProcessMultiDataListener*/{
    ...
    protected int getLayoutId() {
        return com.jiujiu.ecdemo.R.layout.ec_call_interface;
    }
    ...
    private void initCall() {
        ...
        if (!mIncomingCall) {
            ...
            if (TextUtils.isEmpty(mCallNumber)) {
                ToastUtil.showMessage(com.jiujiu.ecdemo.R.string.ec_call_number_error);
                finish();
                return;
            }
            ...
            if (isCallBack) {
                ...
                if (TextUtils.isEmpty(mCallId)) {
                    ToastUtil.showMessage(com.jiujiu.ecdemo.R.string.ec_app_err_disconnect_server_tip);
                    LogUtil.d(TAG, "Call fail, callId " + mCallId);
                    finish();
                    return;
                }
            }
            mCallHeaderView .setCallTextMsg(com.jiujiu.ecdemo.R.string.ec_voip_call_connecting_server);
        } else {
    ...
    private void initView() {
        mCallHeaderView = (ECCallHeadUILayout) findViewById(com.jiujiu.ecdemo.R.id.call_header_ll);
        mCallControlUIView = (ECCallControlUILayout) findViewById(com.jiujiu.ecdemo.R.id.call_control_ll);
    ...
    public void onCallProceeding(String callId) {
        ...
        mCallHeaderView.setCallTextMsg(com.jiujiu.ecdemo.R.string.ec_voip_call_connect);
    }
    ...
    public void onCallAlerting(String callId) {
        ...
        mCallHeaderView.setCallTextMsg(com.jiujiu.ecdemo.R.string.ec_voip_calling_wait);
...
//        Log.e("aaaaaaaaaaaaa","aa"+p);
    ...
    public void onCallReleased(String callId) {
        ...
        mCallHeaderView.setCalling(false);
        isConnect = false;
        mCallHeaderView.setCallTextMsg(com.jiujiu.ecdemo.R.string.ec_voip_calling_finish);
	...
	public void onMakeCallback(ECError ecError, String caller, String called) {
		...
		if(ecError.errorCode != SdkErrorCode.REQUEST_SUCCESS) {
			...
			mCallHeaderView .setCallTextMsg(com.jiujiu.ecdemo.R.string.ec_voip_call_back_success);
		}
		mCallHeaderView.setCalling(false);
        isConnect = false;
        mCallControlUIView.setControlEnable(false);
