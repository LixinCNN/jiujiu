...
public class LocationActivity extends ECSuperActivity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		getTopBarView().setTopBarToStatus(1, com.jiujiu.ecdemo.R.drawable.topbar_back_bt, -1,
				com.jiujiu.ecdemo.R.string.app_panel_location, this);
		...
		viewCache = LayoutInflater.from(this)
				.inflate(com.jiujiu.ecdemo.R.layout.pop_layout, null);
		tvResult = (TextView) viewCache.findViewById(com.jiujiu.ecdemo.R.id.location_tips);
		mSearch = GeoCoder.newInstance();
		mSearch.setOnGetGeoCodeResultListener(this);

		mMapView = (MapView) findViewById(com.jiujiu.ecdemo.R.id.bmapView);
            ...
            public void onMapClick(LatLng latLng) {  
                ...
                MarkerOptions options = new MarkerOptions().position(point)  
                        .icon(BitmapDescriptorFactory
        						.fromResource(com.jiujiu.ecdemo.R.drawable.icon_marka));
	...
	public void onGetReverseGeoCodeResult(ReverseGeoCodeResult result) {
		...
		if(isTop){
		  getTopBarView().setTopBarToStatus(1, com.jiujiu.ecdemo.R.drawable.topbar_back_bt,
                ...
                getString(com.jiujiu.ecdemo.R.string.app_panel_location), null, this);
		}
...
//		mBaiduMap.animateMapStatus(u);
	...
	protected int getLayoutId() {
		// TODO Auto-generated method stub
		return com.jiujiu.ecdemo.R.layout.activity_location;
	}
