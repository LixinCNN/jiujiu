...
import com.jiujiu.ecdemo.ui.chatting.holder.RichTextViewHolder;
...
public class RichTextRxRow extends BaseChattingRow {
	...
	public View buildChatView(LayoutInflater inflater, View convertView) {
		 ...
		 if (convertView == null ) {
	            convertView = new ChattingItemContainer(inflater, com.jiujiu.ecdemo.R.layout.chatting_item_rich_text_from);
