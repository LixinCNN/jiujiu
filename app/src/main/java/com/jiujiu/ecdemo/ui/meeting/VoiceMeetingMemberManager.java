...
public class VoiceMeetingMemberManager extends MeetingBaseActivity {
    ...
    protected int getLayoutId() {
        return com.jiujiu.ecdemo.R.layout.voice_meeting_members;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getTopBarView().setTopBarToStatus(1, com.jiujiu.ecdemo.R.drawable.topbar_back_bt, -1, com.jiujiu.ecdemo.R.string.meeting_member_mgr_title, this);
        initView();
        // 查询会议成员
    ...
    private void initView() {
        mListView = (ListView) findViewById(com.jiujiu.ecdemo.R.id.meeting_member_lv);
        View emptyView = findViewById(com.jiujiu.ecdemo.R.id.empty_tip_recommend_bind_tv);
        mListAdapter = new MeetingMemberAdapter(this);
    ...
    public class MeetingMemberAdapter extends ArrayAdapter<ECVoiceMeetingMember> {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if(convertView == null || convertView.getTag() == null) {
                view = View.inflate(getContext() , com.jiujiu.ecdemo.R.layout.meeting_member_item, null);

                mViewHolder = new ViewHolder();
                mViewHolder.mNikeName = (TextView) view.findViewById(com.jiujiu.ecdemo.R.id.meeting_contact_item_nick_tv);
                mViewHolder.mPermission = (TextView) view.findViewById(com.jiujiu.ecdemo.R.id.meeting_contact_item_digest_tv);
                mViewHolder.mOperatekick = (Button) view.findViewById(com.jiujiu.ecdemo.R.id.chatroom_contact_kick_ok_btn);
                mViewHolder.mOperateMute = (Button) view.findViewById(com.jiujiu.ecdemo.R.id.chatroom_contact_mute_btn);
                mViewHolder.mAvatar = (ImageView) view.findViewById(com.jiujiu.ecdemo.R.id.content);
            ...
            if(item != null) {
                ...
                if(options.inSpeak == ECVoiceMeetingMsg.ForbidOptions.OPTION_SPEAK_FREE) {
                    mViewHolder.mOperateMute.setText(com.jiujiu.ecdemo.R.string.chatroom_permission_mute);
                } else {
                    mViewHolder.mOperateMute.setText(com.jiujiu.ecdemo.R.string.chatroom_permission_mute_revert);
                }
                mViewHolder.mOperatekick.setText(com.jiujiu.ecdemo.R.string.chatroom_permission_remove);
