...
public class VoiceMeetingCenter extends FrameLayout {
    ...
    private static int[] STATUS_ICON = new int[] {
            com.jiujiu.ecdemo.R.drawable.animation_box01
            , com.jiujiu.ecdemo.R.drawable.animation_box02
            , com.jiujiu.ecdemo.R.drawable.animation_box03
            , com.jiujiu.ecdemo.R.drawable.animation_box04
    };
    ...
    private void initView() {
        mCenterAmplitude = (LinearLayout) findViewById(com.jiujiu.ecdemo.R.id.chatroom_center_status);
    }
