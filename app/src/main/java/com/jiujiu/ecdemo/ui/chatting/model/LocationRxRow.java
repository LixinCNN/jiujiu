...
import com.jiujiu.ecdemo.ui.chatting.holder.LocationViewHolder;
...
public class LocationRxRow extends BaseChattingRow {
	...
	public View buildChatView(LayoutInflater inflater, View convertView) {
		 ...
		 if (convertView == null ) {
	            convertView = new ChattingItemContainer(inflater, com.jiujiu.ecdemo.R.layout.chatting_item_location_from);
