...
import com.jiujiu.ecdemo.ui.chatting.model.LocationRxRow;
...
import com.jiujiu.ecdemo.ui.chatting.model.ChattingSystemRow;
import com.jiujiu.ecdemo.ui.chatting.model.DescriptionTxRow;
import com.jiujiu.ecdemo.ui.chatting.model.LocationTxRow;
import com.jiujiu.ecdemo.ui.chatting.model.RedPacketAckRxRow;
...
public class ChattingListAdapter2 extends CCPListAdapter<ECMessage> {
            ...
            public ChattingListAdapter2(Context ctx, ECMessage ecMessage , String user , long thread) {
                ...
                mVerticalPadding = mContext.getResources().getDimensionPixelSize(com.jiujiu.ecdemo.R.dimen.SmallestPadding);
                mHorizontalPadding = mContext.getResources().getDimensionPixelSize(com.jiujiu.ecdemo.R.dimen.LittlePadding);
                mChatNameColor = new ColorStateList[]{
                        mContext.getResources().getColorStateList(com.jiujiu.ecdemo.R.color.white),
                        mContext.getResources().getColorStateList(com.jiujiu.ecdemo.R.color.chatroom_user_displayname_color)};
            }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if(showTimer) {
                ...
                baseHolder.getChattingTime().setBackgroundResource(com.jiujiu.ecdemo.R.drawable.chat_tips_bg);
