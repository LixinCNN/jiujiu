...
import com.jiujiu.ecdemo.ui.videomeeting.ECGlobalConstants;
import com.jiujiu.ecdemo.ui.videomeeting.MultiVideoconference;
import com.jiujiu.ecdemo.ui.voip.ECCallHeadUILayout.OnSendDTMFDelegate;
...
public abstract class ECVoIPBaseActivity extends ECSuperActivity
    ...
    public void onViewAccept(ECCallControlUILayout controlPanelView, ImageButton view) {
        ...
        mCallHeaderView.setCallTextMsg(com.jiujiu.ecdemo.R.string.ec_voip_calling_accepting);
