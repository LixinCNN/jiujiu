...
public abstract class BaseHolder {
	...
	public void initBaseHolder(View baseView) {
		...
		chattingAvatar = (ImageView) baseView.findViewById(com.jiujiu.ecdemo.R.id.chatting_avatar_iv);
		clickAreaView = baseView.findViewById(com.jiujiu.ecdemo.R.id.chatting_click_area);
