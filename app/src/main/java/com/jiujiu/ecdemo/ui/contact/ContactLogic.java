...
import com.jiujiu.ecdemo.core.ECArrayLists;
...
import com.jiujiu.ecdemo.common.utils.DialNumberMap;
import com.jiujiu.ecdemo.common.utils.ECPropertiesUtil;
import com.jiujiu.ecdemo.common.utils.FileAccessor;
import com.jiujiu.ecdemo.common.utils.LogUtil;
import com.jiujiu.ecdemo.common.utils.ResourceHelper;
import com.jiujiu.ecdemo.core.Phone;
...
public class ContactLogic {
    ...
    public static ArrayList<ECContacts> initContacts() {
        ...
        contacts.setNickname(CCPAppManager.getContext().getString(com.jiujiu.ecdemo.R.string.main_plus_mcmessage));
...
//							char c = name.charAt(i);
    ...
    public static Bitmap getChatroomPhoto(final String groupid) {
        ...
        if(groupid.toUpperCase().startsWith("G")) {
            return BitmapFactory.decodeResource(CCPAppManager.getContext().getResources() , com.jiujiu.ecdemo.R.drawable.group_head);
        }
        return mDefaultBitmap;
    }
    ...
    private static List<BitmapUtil.InnerBitmapEntity> getBitmapEntitys(int count) {
        ...
        String value = ECPropertiesUtil.readData(CCPAppManager.getContext(), String.valueOf(count), com.jiujiu.ecdemo.R.raw.nine_rect);
