package com.jiujiu.ecdemo.ui.interphone;
...
import com.jiujiu.ecdemo.ui.meeting.MeetingHelper;
...
public class InterPhoneChatActivity extends InterPhoneBaseActivity
    ...
    protected int getLayoutId() {
        return com.jiujiu.ecdemo.R.layout.inter_phone_activity;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getTopBarView().setTopBarToStatus(1, com.jiujiu.ecdemo.R.drawable.topbar_back_bt , -1 , com.jiujiu.ecdemo.R.string.ec_app_title_inter_phone , this);
        initView();
            ...
            if(joinMsg != null) {
                ...
                for(ECInterPhoneMeetingMember member : mInterMembers) {
                    if(member != null
                        ...
                        updateTopMeetingBarTips(getString(com.jiujiu.ecdemo.R.string.str_chatroom_join, joinMsg.getWho()));
                        onLineCount++;
                        return true;
                    }
                }
        ...
        if(msg.getMsgType() == ECInterPhoneMeetingMsg.ECInterPhoneMeetingMsgType.EXIT) {
            ...
            for(ECInterPhoneMeetingMember member : mInterMembers) {
                if(member != null
                    ...
                    updateTopMeetingBarTips(getString(com.jiujiu.ecdemo.R.string.str_quit_inter_phone, member.getMember()));
                    onLineCount--;
                    return true;
                }
            }
        ...
        if(msg.getMsgType() == ECInterPhoneMeetingMsg.ECInterPhoneMeetingMsgType.CONTROL_MIC) {
            ...
            for(ECInterPhoneMeetingMember member : mInterMembers) {
                if(member != null
                    ...
                    updateTopMeetingBarTips(getString(com.jiujiu.ecdemo.R.string.str_speaking, member.getMember()));
                    return true;
                }
            }
        }
        ...
        if(msg.getMsgType() == ECInterPhoneMeetingMsg.ECInterPhoneMeetingMsgType.RELEASE_MIC) {
            ...
            for(ECInterPhoneMeetingMember member : mInterMembers) {
                if(member != null
                    ...
                    updateTopMeetingBarTips(getString(com.jiujiu.ecdemo.R.string.str_can_control_mic, member.getMember()));
                    return true;
                }
            }
        }
    ...
    private void updateTopMeetingBarTips(String text) {
        ...
        ECHandlerHelper.postDelayedRunnOnUI(new Runnable() {
            ...
            public void run() {
                if (mBannerView != null) {
                    if (mInterMeetingNo != null) {
                        mBannerView.setTips(getString(com.jiujiu.ecdemo.R.string.current_meeting_voice, mInterMeetingNo));
                    } else {
                        mBannerView.setTips(com.jiujiu.ecdemo.R.string.current_meeting_tips);
                    }
                }
            }
        }, 3000L);
    ...
    private void initView() {
        mBannerView = (InterPhoneBannerView) findViewById(com.jiujiu.ecdemo.R.id.notice_tips_ly);
        mInterPhoneListView = (ListView) findViewById(com.jiujiu.ecdemo.R.id.inter_phone_list);
        mMicController = (InterPhoneMicController) findViewById(com.jiujiu.ecdemo.R.id.inter_phone_speak_ly);
        ...
        updateTopMeetingBarTips(getString(com.jiujiu.ecdemo.R.string.top_tips_connecting_wait));
    }
    ...
    public void onInterPhoneStart(String interNo) {
        ...
        updateTopMeetingBarTips(CCPAppManager.getUserId() + getString(com.jiujiu.ecdemo.R.string.str_join_inter_phone_success));
        mBannerView.setOnLineCount(getOnLineCount(), mInterMembers.size());
    }
    ...
    private void exitInterPhone() {
        ECAlertDialog buildAlert = ECAlertDialog.buildAlert(this, com.jiujiu.ecdemo.R.string.talk_room_exit_room_tip
                , com.jiujiu.ecdemo.R.string.app_exit, com.jiujiu.ecdemo.R.string.app_cancel , new DialogInterface.OnClickListener() {
            @Override
        ...
        buildAlert.setTitle(com.jiujiu.ecdemo.R.string.talk_room_exit_room);
        buildAlert.show();
    }
    ...
    public void onControlMic() {
        mBannerView.setTips(com.jiujiu.ecdemo.R.string.top_tips_connecting_wait);
    ...
    public void onReleaseMic() {
        ...
        mBannerView.setTips(com.jiujiu.ecdemo.R.string.top_tips_intercom_ing);
    }
    ...
    private boolean controlOrReleaseMic(boolean control) {
                ...
                public void onControlMicState(ECError reason, String speaker) {
                    if(SdkErrorCode.REQUEST_SUCCESS == reason.errorCode) {
                        ...
                        try {
                            ...
                            updateTopMeetingBarTips(getString(com.jiujiu.ecdemo.R.string.str_control_mic_success));
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                        // 更新状态
                    ...
                    updateTopMeetingBarTips(getString(com.jiujiu.ecdemo.R.string.str_control_mic_failed));
        ...
        meetingManager.releaseMicInInterPhoneMeeting(mInterMeetingNo, new ECMeetingManager.OnReleaseMicInInterPhoneListener() {
            ...
            public void onReleaseMicState(ECError reason) {
                ...
                updateTopMeetingBarTips(getString(com.jiujiu.ecdemo.R.string.str_release_mic_failed));
            }
        });
    ...
    public class InterPhoneMemberAdapter extends ArrayAdapter<ECInterPhoneMeetingMember> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if(convertView == null  || convertView.getTag() == null) {
                view = View.inflate(getContext(), com.jiujiu.ecdemo.R.layout.inter_phone_item, null);
