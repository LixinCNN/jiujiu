...
import com.jiujiu.ecdemo.ui.chatting.holder.SystemViewHolder;
...
public class ChattingSystemRow extends BaseChattingRow {
	...
	public View buildChatView(LayoutInflater inflater, View convertView) {
		...
		if (convertView == null || convertView.getTag() == null || ((BaseHolder)convertView.getTag()).getType() != mRowType) {
			convertView =  inflater.inflate(com.jiujiu.ecdemo.R.layout.chatting_item_system, null);

			// use the view holder pattern to save of already looked up subviews
			SystemViewHolder holder = new SystemViewHolder(mRowType);
			holder.setChattingTime((TextView) convertView.findViewById(com.jiujiu.ecdemo.R.id.chatting_time_tv));
			holder.mSystemView = (TextView) convertView.findViewById(com.jiujiu.ecdemo.R.id.chatting_content_itv);
