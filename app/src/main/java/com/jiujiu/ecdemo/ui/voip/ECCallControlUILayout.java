...
public class ECCallControlUILayout extends LinearLayout
    ...
    public ECCallControlUILayout(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs);
        initView();
        TypedArray typedArray = context.obtainStyledAttributes(attrs , com.jiujiu.ecdemo.R.styleable.call_control);
        int callDirect = typedArray.getInt(com.jiujiu.ecdemo.R.styleable.call_control_call_direct , 0);
        // 设置呼叫界面显示
    ...
    private void initView() {
        View.inflate(getContext(), com.jiujiu.ecdemo.R.layout.ec_call_control_layout, this);
        // 来电显示界面
        mIncomingCallLayout = (LinearLayout) findViewById(com.jiujiu.ecdemo.R.id.incoming_call_bottom_show);
        mCallCancel = (ImageButton) findViewById(com.jiujiu.ecdemo.R.id.layout_call_cancel);
        mCallAccept = (ImageButton) findViewById(com.jiujiu.ecdemo.R.id.layout_call_accept);
        mCallAccept.setOnClickListener(this);
        mCallCancel.setOnClickListener(this);

		// 通话进行过程中显示
		mCallingshowPanel = (LinearLayout) findViewById(com.jiujiu.ecdemo.R.id.calling_bottom_show);
		// 通话控制按钮区域
		mCallSetupLayout = (LinearLayout) findViewById(com.jiujiu.ecdemo.R.id.call_mute_container);
		mCallMute = (ImageView) findViewById(com.jiujiu.ecdemo.R.id.layout_call_mute);
		mCallHandFree = (ImageView) findViewById(com.jiujiu.ecdemo.R.id.layout_call_handfree);
		...
		mDiaerpadBtn = (ImageView) findViewById(com.jiujiu.ecdemo.R.id.layout_call_dialnum);

        // 挂断电话按钮
        mCallRelease = (ImageButton) findViewById(com.jiujiu.ecdemo.R.id.layout_call_release);
	...
	private OnClickListener l = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			switch (v.getId()) {
			case com.jiujiu.ecdemo.R.id.layout_call_mute:
				VoIPCallHelper.setMute();
                boolean mute = VoIPCallHelper.getMute();
                mCallMute.setImageResource(mute ? com.jiujiu.ecdemo.R.drawable.ec_call_interface_mute_on : com.jiujiu.ecdemo.R.drawable.ec_call_interface_mute);

                break;
			case com.jiujiu.ecdemo.R.id.layout_call_handfree:
				VoIPCallHelper.setHandFree();
                boolean handFree = VoIPCallHelper.getHandFree();
                mCallHandFree .setImageResource(handFree ? com.jiujiu.ecdemo.R.drawable.ec_call_interface_hands_free_on : com.jiujiu.ecdemo.R.drawable.ec_call_interface_hands_free);
				break;
			case com.jiujiu.ecdemo.R.id.layout_call_dialnum:
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case com.jiujiu.ecdemo.R.id.layout_call_accept:
            	ImageButton view = (ImageButton) v;
                mOnCallControlDelegate.onViewAccept(this, view);
                break;
            case com.jiujiu.ecdemo.R.id.layout_call_cancel:
            	ImageButton viewCancel = (ImageButton) v;
                mOnCallControlDelegate.onViewReject(this , viewCancel);
                break;
            case com.jiujiu.ecdemo.R.id.layout_call_release:
