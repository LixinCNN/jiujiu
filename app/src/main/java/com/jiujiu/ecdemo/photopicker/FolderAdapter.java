    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(mContext).inflate(
                    com.jiujiu.ecdemo.R.layout.picker_item_floder_layout, null);
            holder.photoIV = (ImageView) convertView.findViewById(com.jiujiu.ecdemo.R.id.imageview_floder_img);
            holder.folderNameTV = (TextView) convertView.findViewById(com.jiujiu.ecdemo.R.id.textview_floder_name);
            holder.photoNumTV = (TextView) convertView.findViewById(com.jiujiu.ecdemo.R.id.textview_photo_num);
            holder.selectIV = (ImageView) convertView.findViewById(com.jiujiu.ecdemo.R.id.imageview_floder_select);
            convertView.setTag(holder);
        } else {
            holder = (ViewHolder) convertView.getTag();
        }
        holder.selectIV.setVisibility(View.GONE);
        holder.photoIV.setImageResource(com.jiujiu.ecdemo.R.drawable.picker_ic_photo_loading);
