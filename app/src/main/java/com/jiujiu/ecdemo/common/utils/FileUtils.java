...
public class FileUtils {
	...
	public static int getFileIcon(String fileName) {
		...
		if (isDocument(fileType)) {
			return com.jiujiu.ecdemo.R.drawable.file_attach_doc;
		}
		if (isPic(fileType)) {
			return com.jiujiu.ecdemo.R.drawable.file_attach_img;
		}

		if (isCompresseFile(fileType)) {
			return com.jiujiu.ecdemo.R.drawable.file_attach_rar;
		}
		if (isTextFile(fileType)) {
			return com.jiujiu.ecdemo.R.drawable.file_attach_txt;
		}
		if (isPdf(fileType)) {
			return com.jiujiu.ecdemo.R.drawable.file_attach_pdf;
		}

		if (isPPt(fileType)) {
			return com.jiujiu.ecdemo.R.drawable.file_attach_ppt;
		}

		if (isXls(fileType)) {
			return com.jiujiu.ecdemo.R.drawable.file_attach_xls;
		}
		return com.jiujiu.ecdemo.R.drawable.file_attach_ohter;
	}
