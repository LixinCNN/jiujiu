...
public class NetWarnBannerView extends LinearLayout {
     ...
     */
    private void init() {
        View.inflate(getContext(), com.jiujiu.ecdemo.R.layout.net_warn_item, this);
        mContetLayout = findViewById(com.jiujiu.ecdemo.R.id.nwview);
        mNetWarnIcon = (ImageView) findViewById(com.jiujiu.ecdemo.R.id.nw_icon);
        mNetDetail = (TextView) findViewById(com.jiujiu.ecdemo.R.id.nw_detail);
        mNetDetailTips = (TextView) findViewById(com.jiujiu.ecdemo.R.id.nw_detail_tip);
        mNetHintTips = (TextView) findViewById(com.jiujiu.ecdemo.R.id.nw_hint_tip);
        mProgressBar = (ProgressBar) findViewById(com.jiujiu.ecdemo.R.id.nw_prog);
