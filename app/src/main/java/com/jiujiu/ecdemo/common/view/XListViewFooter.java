...
public class XListViewFooter extends LinearLayout {
	...
	private void initView(Context context) {
		...
		LinearLayout moreView = (LinearLayout) LayoutInflater.from(mContext)
				.inflate(com.jiujiu.ecdemo.R.layout.xlistview_footer, null);
		addView(moreView);
		moreView.setLayoutParams(new LayoutParams(
				LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT));

		mContentView = moreView.findViewById(com.jiujiu.ecdemo.R.id.xlistview_footer_content);
		mProgressBar = moreView.findViewById(com.jiujiu.ecdemo.R.id.xlistview_footer_progressbar);
		mHintView = (TextView) moreView
				.findViewById(com.jiujiu.ecdemo.R.id.xlistview_footer_hint_textview);
	}
