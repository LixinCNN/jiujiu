...
public class ECAlertDialog extends Dialog implements View.OnClickListener {
    ...
    public ECAlertDialog(Context context) {
        super(context, com.jiujiu.ecdemo.R.style.Theme_Light_FullScreenDialogAct);
        super.setContentView(com.jiujiu.ecdemo.R.layout.common_dialog_generic);
        initView();
    }
    ...
    private void initView() {
        ...
        Button leftBtn = (Button) findViewById(com.jiujiu.ecdemo.R.id.dilaog_button1);
        leftBtn.setOnClickListener(this);
        mButtons.add(leftBtn);
        Button middleBtn = (Button) findViewById(com.jiujiu.ecdemo.R.id.dilaog_button2);
        middleBtn.setOnClickListener(this);
        mButtons.add(middleBtn);
        Button rightBtn = (Button) findViewById(com.jiujiu.ecdemo.R.id.dilaog_button3);
        rightBtn.setOnClickListener(this);
        mButtons.add(rightBtn);
        mLayoutTitle = findViewById(com.jiujiu.ecdemo.R.id.dialog_layout_title);
        mLayoutContent = ((ViewGroup) findViewById(com.jiujiu.ecdemo.R.id.dialog_layout_content));
        mLayoutButton = findViewById(com.jiujiu.ecdemo.R.id.dialog_layout_button);
        setCancelable(true);
        setCanceledOnTouchOutside(true);
        setTitle(com.jiujiu.ecdemo.R.string.dialog_title_alert);
    }
    ...
    public static ECAlertDialog buildAlert(Context ctx, int resId, OnClickListener listener) {
        return buildAlert(ctx, resId, com.jiujiu.ecdemo.R.string.dialog_btn_cancel, com.jiujiu.ecdemo.R.string.dialog_btn_confim, null, listener);
    }
    ...
    public static ECAlertDialog buildAlert(Context ctx, int resId,
        ...
        return buildAlert(ctx, ctx.getString(resId), ctx.getString(com.jiujiu.ecdemo.R.string.dialog_btn_cancel), ctx.getString(com.jiujiu.ecdemo.R.string.dialog_btn_confim), negativeClickListener, positive);
    }

    public static ECAlertDialog buildAlert(Context ctx, CharSequence message,
                                           OnClickListener listener) {
        return buildAlert(ctx, message, ctx.getString(com.jiujiu.ecdemo.R.string.dialog_btn_cancel), ctx.getString(com.jiujiu.ecdemo.R.string.dialog_btn_confim), null, listener);
    }

    public static ECAlertDialog buildAlert(Context ctx, CharSequence message,
                                           OnClickListener negativeClickListener,
                                           OnClickListener positive) {
        return buildAlert(ctx, message, ctx.getString(com.jiujiu.ecdemo.R.string.dialog_btn_cancel), ctx.getString(com.jiujiu.ecdemo.R.string.dialog_btn_confim), negativeClickListener, positive);
    }
    ...
    public static ECAlertDialog buildPositiveAlert(Context ctx , CharSequence message , OnClickListener listener) {
        ECAlertDialog dialog = new ECAlertDialog(ctx);
        dialog.setMessage(message);
        dialog.setButton(BUTTON_POSITIVE, ctx.getString(com.jiujiu.ecdemo.R.string.dialog_btn_confim), listener);
        return dialog;
    }
    ...
    public final void setMessage(CharSequence text) {
        ((TextView)findViewById(com.jiujiu.ecdemo.R.id.dialog_tv_message)).setText(text);
    }

    public final void setTitleNormalColor() {
        ((TextView)findViewById(com.jiujiu.ecdemo.R.id.dialog_tv_title)).setTextColor(getContext().getResources().getColor(com.jiujiu.ecdemo.R.color.text_content));
    }
    ...
    public void setTitle(CharSequence text) {
        ...
        ((TextView) findViewById(com.jiujiu.ecdemo.R.id.dialog_tv_title)).setText(text);
        mLayoutContent.setVisibility(View.VISIBLE);
    ...
    public void show() {
        ...
        if (i == 1) {
            btn.setBackgroundResource(com.jiujiu.ecdemo.R.drawable.btn_dialog_single);
        }
        if (i == 2) {
