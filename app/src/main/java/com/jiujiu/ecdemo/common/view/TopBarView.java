...
public class TopBarView extends LinearLayout {
    ...
    private void initView() {
        ...
        setBackgroundDrawable(new ColorDrawable(mContext.getResources().getColor(com.jiujiu.ecdemo.R.color.red_btn_color_normal)));
        LayoutInflater.from(getContext()).inflate(com.jiujiu.ecdemo.R.layout.common_view_top_bar, this, true);
        mLeftButton = (ImageView) findViewById(com.jiujiu.ecdemo.R.id.btn_left);
        mMiddleButton = (EmojiconTextView) findViewById(com.jiujiu.ecdemo.R.id.btn_middle);
        mMiddleSub = (TextView) findViewById(com.jiujiu.ecdemo.R.id.btn_middle_sub);
        mRightButton = (ImageView) findViewById(com.jiujiu.ecdemo.R.id.btn_right);
        mLeftText = (TextView) findViewById(com.jiujiu.ecdemo.R.id.text_left);
        mRightText = (TextView) findViewById(com.jiujiu.ecdemo.R.id.text_right);
    }
    ...
    public void showTopProgressbar() {
        ...
        ((RelativeLayout)findViewById(com.jiujiu.ecdemo.R.id.top_progressbar)).setVisibility(View.VISIBLE);
    }
    ...
    public void setRightButtonRes(int resId) {
        ...
        int padding = getContext().getResources().getDimensionPixelSize(com.jiujiu.ecdemo.R.dimen.btn_topbar_paddingHorizontal);
    ...
    public void setTopbarUpdatePoint(boolean show) {
        View mTopbarUpdatePoint = findViewById(com.jiujiu.ecdemo.R.id.topbar_update_point);
        if(show) {
    ...
    public void setRightVisible() {
        ...
        ((RelativeLayout)findViewById(com.jiujiu.ecdemo.R.id.top_progressbar)).setVisibility(View.GONE);
    }
    ...
    public void setTopbarRightPoint(boolean show) {
        View mTopbarRightPoint = findViewById(com.jiujiu.ecdemo.R.id.right_point);
        if(show) {
    ...
    public void setMiddleBtnArrowUp(boolean up , boolean arrow) {
        ...
        mArrowUp = up;
        int id = com.jiujiu.ecdemo.R.drawable.common_top_bar_arrow_down;
        if(mArrowUp) {
            id = com.jiujiu.ecdemo.R.drawable.common_top_bar_arrow_up;
        }
    ...
    public  void setTopBarToStatus(int type, int leftResid, int rightResid, String leftText, String rightText, String title, String subTitle, OnClickListener l) {
        mClickListener = l;
        findViewById(com.jiujiu.ecdemo.R.id.common_top_wrapper).setOnClickListener(mClickListener);
        int padding = getContext().getResources().getDimensionPixelSize(com.jiujiu.ecdemo.R.dimen.btn_topbar_paddingHorizontal);
