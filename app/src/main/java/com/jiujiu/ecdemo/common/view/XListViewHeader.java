...
public class XListViewHeader extends LinearLayout {
	...
	private void initView(Context context) {
		...
		mContainer = (LinearLayout) LayoutInflater.from(context).inflate(
				com.jiujiu.ecdemo.R.layout.xlistview_header, null);
		addView(mContainer, lp);
		setGravity(Gravity.BOTTOM);
		// 找到头部页面里的控件
		mArrowImageView = (ImageView) findViewById(com.jiujiu.ecdemo.R.id.xlistview_header_arrow);
		mHintTextView = (TextView) findViewById(com.jiujiu.ecdemo.R.id.xlistview_header_hint_textview);
		mProgressBar = (ProgressBar) findViewById(com.jiujiu.ecdemo.R.id.xlistview_header_progressbar);
