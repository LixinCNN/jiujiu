...
public class MethodInvoke {
    ...
    public static void startTransitionPopin(Context context) {
        ...
        ((Activity) context).overridePendingTransition(com.jiujiu.ecdemo.R.anim.pop_in, com.jiujiu.ecdemo.R.anim.anim_not_change);
    }
    ...
    public static void startTransitionPopout(Context context) {
        ...
        ((Activity) context).overridePendingTransition(com.jiujiu.ecdemo.R.anim.anim_not_change, com.jiujiu.ecdemo.R.anim.pop_out);
    }
    ...
    public static void startTransitionNotChange(Context context) {
        ...
        ((Activity) context).overridePendingTransition(com.jiujiu.ecdemo.R.anim.anim_not_change, com.jiujiu.ecdemo.R.anim.anim_not_change);
    }
