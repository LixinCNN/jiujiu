...
public class SettingItem extends RelativeLayout {
    ...
    public SettingItem(Context context, AttributeSet attrs) {
        super(context, attrs);
        LayoutInflater.from(context).inflate(com.jiujiu.ecdemo.R.layout.detaillist_item, this, true);

        mContent = (LinearLayout) findViewById(com.jiujiu.ecdemo.R.id.content);
        mTitle = (TextView) findViewById(android.R.id.title);
        mSummary = (TextView) findViewById(android.R.id.summary);
        mNewUpdate = (TextView) findViewById(com.jiujiu.ecdemo.R.id.text_tv_one);
        mCheckedTextView = (CheckedTextView) findViewById(com.jiujiu.ecdemo.R.id.accessory_checked);
        mDividerView = findViewById(com.jiujiu.ecdemo.R.id.item_bottom_divider);

        TypedArray localTypedArray = context.obtainStyledAttributes(attrs, com.jiujiu.ecdemo.R.styleable.setting_info);
        setTitleText(localTypedArray.getString(com.jiujiu.ecdemo.R.styleable.setting_info_item_titleText));
        setDetailText(localTypedArray.getString(com.jiujiu.ecdemo.R.styleable.setting_info_item_detailText));
        setAccessoryType(localTypedArray.getInt(com.jiujiu.ecdemo.R.styleable.setting_info_item_accessoryType , 0));
        setShowDivider(localTypedArray.getBoolean(com.jiujiu.ecdemo.R.styleable.setting_info_item_showDivider , true));
    ...
    private void setAccessoryType(int accessoryType) {
        if(accessoryType == ACCESSORY_TYPE_CHECKBOX) {
            ...
            mCheckedTextView.setCheckMarkDrawable(getContext().getResources().getDrawable(com.jiujiu.ecdemo.R.drawable.icon_switch));
