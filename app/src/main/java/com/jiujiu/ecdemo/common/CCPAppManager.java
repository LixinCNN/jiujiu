...
import com.jiujiu.ecdemo.ui.chatting.ImageGalleryActivity;
import com.jiujiu.ecdemo.ui.chatting.ImageGralleryPagerActivity;
import com.jiujiu.ecdemo.ui.chatting.ImageMsgInfoEntry;
import com.jiujiu.ecdemo.ui.chatting.ViewImageInfo;
import com.jiujiu.ecdemo.ui.chatting.view.ChatFooterPanel;
import com.jiujiu.ecdemo.ui.voip.VideoActivity;
...
import com.jiujiu.ecdemo.ui.ShowBaiDuMapActivity;
...
public class CCPAppManager {
    ...
    public static void showCallMenu(final Context ctx , final String nickname, final String contactId) {
        ECListDialog dialog = new ECListDialog(ctx , com.jiujiu.ecdemo.R.array.chat_call);;
        ...
        dialog.setTitle(com.jiujiu.ecdemo.R.string.ec_talk_mode_select);
        dialog.show();
    }
    ...
    public static void showCodecConfigMenu(final Context ctx) {
        final ECListDialog multiDialog = new ECListDialog(ctx , com.jiujiu.ecdemo.R.array.Codec_call);
...
//            mChecks.add(ECVoIPSetupManager.Codec.Codec_OPUS48.ordinal());
        ...
        multiDialog.setTitle(com.jiujiu.ecdemo.R.string.ec_talk_codec_select);
        multiDialog.setButton(ECListDialog.BUTTON_POSITIVE, com.jiujiu.ecdemo.R.string.dialog_ok_button, new DialogInterface.OnClickListener() {
            @Override
