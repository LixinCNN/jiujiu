...
public class CCPLauncherUITabView extends RelativeLayout implements View.OnClickListener {
    ...
    private void init() {
        ...
        layout.setId(com.jiujiu.ecdemo.R.id.main_tab_root);
        ...
        imageView.setId(com.jiujiu.ecdemo.R.id.main_tab_navigation_img);
        LayoutParams imageViewLayoutParams = new LayoutParams(-1, DensityUtil.fromDPToPix(getContext(), 3));
        imageViewLayoutParams.addRule(RelativeLayout.ALIGN_BOTTOM, com.jiujiu.ecdemo.R.id.main_tab_root);
        addView(mSlideImage = imageView, imageViewLayoutParams);

        // TabView dial
        TabViewHolder tabViewMain = createTabView(TAB_VIEW_MAIN);
        tabViewMain.tabView.setText(com.jiujiu.ecdemo.R.string.main_title);
        LinearLayout.LayoutParams enbGroupLayoutParams = new LinearLayout.LayoutParams(
                0, getResources().getDimensionPixelSize(com.jiujiu.ecdemo.R.dimen.DefaultTabbarHeight));
        ...
        tabViewSecond.tabView.setText(com.jiujiu.ecdemo.R.string.main_contact);
        ...
        tabViewContacts.tabView.setText(com.jiujiu.ecdemo.R.string.main_group);
        ...
        tabViewDisGroup.tabView.setText(com.jiujiu.ecdemo.R.string.me);
    ...
    public final void updateMainTabUnread(int unreadCount) {
        ...
        if(unreadCount > 0) {
            if(unreadCount > 99) {
                mMainTabView.tabView.setUnreadTips(getResources().getString(com.jiujiu.ecdemo.R.string.unread_count_overt_100));
                return;
            }
    ...
    public final void updateSecondTabUnread(int unreadCount) {
        ...
        if(unreadCount > 0) {
            if(unreadCount > 99) {
                mSecondTabView.tabView.setUnreadTips(getResources().getString(com.jiujiu.ecdemo.R.string.unread_count_overt_100));
                return;
            }
    ...
    public final void updateContactsTabUnread(int unreadCount) {
        ...
        if(unreadCount > 0) {
            if(unreadCount > 99) {
                mThirdTabView.tabView.setUnreadTips(getResources().getString(com.jiujiu.ecdemo.R.string.unread_count_overt_100));
                return;
            }
    ...
    public final void doChangeTabViewDisplay(int index) {
        ...
        switch (index) {
            case TAB_VIEW_MAIN:
                mMainTabView.tabView.setTextColor(getResources().getColorStateList(com.jiujiu.ecdemo.R.color.red_btn_color_normal));
                mSecondTabView.tabView.setTextColor(getResources().getColorStateList(com.jiujiu.ecdemo.R.color.launcher_tab_text_selector));
                mThirdTabView.tabView.setTextColor(getResources().getColorStateList(com.jiujiu.ecdemo.R.color.launcher_tab_text_selector));
                mFourTabView.tabView.setTextColor(getResources().getColorStateList(com.jiujiu.ecdemo.R.color.launcher_tab_text_selector));
                break;
            case TAB_VIEW_SECOND:
                mMainTabView.tabView.setTextColor(getResources().getColorStateList(com.jiujiu.ecdemo.R.color.launcher_tab_text_selector));
                mSecondTabView.tabView.setTextColor(getResources().getColorStateList(com.jiujiu.ecdemo.R.color.red_btn_color_normal));
                mThirdTabView.tabView.setTextColor(getResources().getColorStateList(com.jiujiu.ecdemo.R.color.launcher_tab_text_selector));
                mFourTabView.tabView.setTextColor(getResources().getColorStateList(com.jiujiu.ecdemo.R.color.launcher_tab_text_selector));
                break;
            case TAB_VIEW_THIRD:
                mMainTabView.tabView.setTextColor(getResources().getColorStateList(com.jiujiu.ecdemo.R.color.launcher_tab_text_selector));
                mSecondTabView.tabView.setTextColor(getResources().getColorStateList(com.jiujiu.ecdemo.R.color.launcher_tab_text_selector));
                mThirdTabView.tabView.setTextColor(getResources().getColorStateList(com.jiujiu.ecdemo.R.color.red_btn_color_normal));
                mFourTabView.tabView.setTextColor(getResources().getColorStateList(com.jiujiu.ecdemo.R.color.launcher_tab_text_selector));
            ...
            case TAB_VIEW_FOUR:
            	...
            	mSecondTabView.tabView.setTextColor(getResources().getColorStateList(com.jiujiu.ecdemo.R.color.launcher_tab_text_selector));
            	mThirdTabView.tabView.setTextColor(getResources().getColorStateList(com.jiujiu.ecdemo.R.color.launcher_tab_text_selector));
            	mFourTabView.tabView.setTextColor(getResources().getColorStateList(com.jiujiu.ecdemo.R.color.red_btn_color_normal));
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if(mIndicatorBitmap == null || mIndicatorBitmap.getWidth() != mTabViewBaseWidth) {
            ...
            canvas.drawColor(getResources().getColor(com.jiujiu.ecdemo.R.color.red_btn_color_normal));
