        ...
        new Thread() {
            ...
            public void run() {
                ...
                ECAlertDialog buildAlert = ECAlertDialog.buildAlert(mContext, "我先休息下，你快去找工程师，我挂了！",
                        mContext.getString(com.jiujiu.ecdemo.R.string.dialog_btn_confim), new DialogInterface.OnClickListener() {
                            @Override
                ...
                buildAlert.setTitle(com.jiujiu.ecdemo.R.string.app_crash_tips);
