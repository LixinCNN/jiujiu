...
import com.jiujiu.ecdemo.ui.chatting.base.EmojiconHandler;
import com.jiujiu.ecdemo.ui.chatting.base.emoji.Emojicon;
import com.jiujiu.ecdemo.ui.chatting.base.emoji.People;
...
public class EmoticonUtil {
	...
	public static SpannableString emoji2CharSequence(Context context , String str , int textSize , boolean isReplaceLine) {
		...
		if(textSize == -1) {
			textSize = context.getResources().getDimensionPixelSize(com.jiujiu.ecdemo.R.dimen.ccp_button_text_size);
		} else if (textSize == -2) {
			textSize = context.getResources().getDimensionPixelSize(com.jiujiu.ecdemo.R.dimen.primary_text_size);
		}
	...
	public static SpannableString getTextFormat(Context context , String format , int paddingSize) {
		...
		switch (paddingSize) {
			case -1:
				paddingSize = context.getResources().getDimensionPixelSize(com.jiujiu.ecdemo.R.dimen.ccp_button_text_size);
				break;
			case -2:
				paddingSize = context.getResources().getDimensionPixelSize(com.jiujiu.ecdemo.R.dimen.primary_text_size);
				break;
			default:
				break;
		}
