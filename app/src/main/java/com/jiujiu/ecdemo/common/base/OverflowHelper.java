...
public class OverflowHelper {
    ...
    public OverflowHelper(Context ctx) {
        mContext = ctx;
        mNormalColor = mContext.getResources().getColor(com.jiujiu.ecdemo.R.color.white);
        mDisabledColor = mContext.getResources().getColor(com.jiujiu.ecdemo.R.color.text_disabled);
        mPopupLayout = (LinearLayout) LayoutInflater.from(mContext).inflate(com.jiujiu.ecdemo.R.layout.comm_popup_menu, null, true);
        mListView = (PopupMenuListView) mPopupLayout.findViewById(com.jiujiu.ecdemo.R.id.comm_popup_list);
