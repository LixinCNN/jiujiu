...
import com.jiujiu.ecdemo.common.SwipTranslucentMethodUtils;
import com.jiujiu.ecdemo.common.SwipeActivityManager;
import com.jiujiu.ecdemo.common.ViewDragHelper;
...
public class SwipeBackLayout extends FrameLayout {
    ...
    public SwipeBackLayout(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs);
        mShadowLeft = getResources().getDrawable(com.jiujiu.ecdemo.R.drawable.shadow_left);
        setFocusable(true);
        ...
        public void onViewDragStateChanged(int state) {
            ...
            if(state == ViewDragHelper.STATE_DRAGGING) {
                ...
                if(SwipeBackLayout.this.getContext() instanceof Activity) {
                    ((Activity)SwipeBackLayout.this.getContext()).getWindow().getDecorView().setBackgroundResource(com.jiujiu.ecdemo.R.drawable.transparent);
                }
