    ...
    public final void buildViewDesc(View view , String text , String desc , int index) {
        ...
        if(!TextUtils.isEmpty(desc)) {
            try {
                ...
                tool.addViewDesc(resources.getQuantityString(com.jiujiu.ecdemo.R.plurals.tab_desc_unread, 1, parseInt));

                String quantityString = resources.getQuantityString(com.jiujiu.ecdemo.R.plurals.tab_name_site_desc, 5, 3);
